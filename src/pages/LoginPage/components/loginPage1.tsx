...
const LoginPage1: React.FC<LoginPageProps> = ({
  loading,
  type,
  isCounting,
  rememberMe,
  ...
  return (
    <div
      ...
      <div className="w-[78%] h-[74%] flex justify-center">
        ...
        <div className="w-[33.33%] h-full flex justify-center shadow-[0_2px_6px_0_rgba(227,236,251,1)]"
          style={{
            backgroundColor: `rgba(255, 255, 255, ${showTransparency})`,
            overflowY: 'auto',
            scrollbarWidth: 'thin',
            scrollbarColor: 'rgba(155, 155, 155, 0.5) transparent'
          }}>
          {!showForgotPassword ? <div className="w-full flex justify-center items-center">
            <div className="w-[64%] h-full relative">
              ...
              {showLogo ? (
                ...
                <div className="h-[16%]">
                  ...
                  <div className="h-[55%] text-[#90A0AF] text-[18px] font-pingfang-medium">
                    {welcomeTitle}
                  </div>
                </div>
              )}
              ...
              <div className='h-[50%] w-full'>
                <Form onFinish={handleSubmit} layout='vertical' className='w-full h-full' form={form}>
                  ...
                  <Form.Item
                    ...
                    <Button
                      className="w-full h-[46px] mt-[20px] login-type-switch-btn"
                      onClick={() => switchLoginType(type === '用户登录' ? '手机登录' : '用户登录')}
                    >
                      {type === '用户登录' ? '验证码登录' : '账号登录'}
                    </Button>
                  </Form.Item>
                </Form>
              </div>

              {/* <div className="absolute bottom-[10%] left-0 right-0 h-[5%] text-[#5A6875] text-[14px] flex items-center justify-center">
                <span
