...
const LoginPage2: React.FC<LoginPageProps> = ({
  loading,
  type,
  isCounting,
  rememberMe,
    ...
    <div
      ...
      <div className="w-[78%] h-[74%] flex justify-center">
        <div className="w-[33.33%] h-full flex justify-center shadow-[0_2px_6px_0_rgba(227,236,251,1)]"
          style={{ backgroundColor: `rgba(255, 255, 255, ${showTransparency})` }}>
          {showForgotPassword ? (
              ...
              <div className="w-[64%] h-full relative">
                ...
                {showLogo ? (
                  ...
                  <div className="h-[16%]">
                    ...
                    <div className="h-[55%] text-[#90A0AF] text-[18px]">
                      {welcomeTitle}
                    </div>
                  </div>
                )}
        ...
        <div className="w-[66.67%] h-full bg-[#fff]">
          {showBg && <img
            src={bgUrl}
            alt=""
            style={{
