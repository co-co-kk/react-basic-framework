...
const LoginPage4: React.FC<LoginPageProps> = ({
  loading,
  type,
  isCounting,
  rememberMe,
  ...
  return (
    <div
      ...
      <div className="w-[26%] h-[60%] flex justify-center">
        <div className="w-[100%] h-full bg-[rgba(0,0,0,0.5)] rounded-[10px] flex justify-center shadow-[0_2px_6px_0_rgba(0,47,167,0.23)]"
