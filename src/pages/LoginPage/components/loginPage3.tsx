...
const LoginPage3: React.FC<LoginPageProps> = ({
  loading,
  type,
  isCounting,
  rememberMe,
  ...
  .verification-code-btn:disabled {
    ...
    cursor: not-allowed;
    transform: none !important; /* 防止缩放效果在禁用时生效 */
  }
  ...
  return (
    <div
      ...
      <div className="w-[26%] h-[60%] rounded-[10px] flex justify-center mr-[11%]">
        <div className="w-[100%] h-full bg-[#fff] flex justify-center shadow-[0_2px_6px_0_rgba(227,236,251,1)] rounded-[10px]"
          ...
          {showForgotPassword ? (
            ...
            <div className="w-full flex justify-center items-center">
              <div className="w-[64%] h-full relative">
                ...
                {/* <div className="absolute bottom-[5%] left-0 right-0 h-[5%] text-[#5A6875] text-[14px] flex items-center justify-center">
                  <span
